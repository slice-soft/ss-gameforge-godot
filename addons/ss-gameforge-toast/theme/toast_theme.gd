...
@export var info_icon: Texture2D = load("res://addons/ss-gameforge-toast/assets/icons/info.svg")

@export_group("Success")
@export var success_background_color := Color("#27AE60")
@export var success_text_color := Color.WHITE
@export var success_icon: Texture2D = load("res://addons/ss-gameforge-toast/assets/icons/success.svg")

@export_group("Danger")
@export var danger_background_color := Color("#EB5757")
@export var danger_text_color := Color.WHITE
@export var danger_icon: Texture2D = load("res://addons/ss-gameforge-toast/assets/icons/danger.svg")
...
@export var loader_icon: Texture2D = load("res://addons/ss-gameforge-toast/assets/icons/loader.svg")
